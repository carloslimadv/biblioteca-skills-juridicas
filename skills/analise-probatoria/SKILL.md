...
description: |
  Skill de analise probatoria estruturada para valorar documentos, autenticidade aparente, admissibilidade, lacunas e risco adversarial em casos juridicos. Acionar somente quando o usuario selecionar explicitamente esta skill na conversa ou invocar `$analise-probatoria`. Nao autoacionar por mencoes genericas a documentos, provas ou estrategia processual.
---
...
- Se a analise probatoria precisar ser convertida em peca, migrar depois para `peticao-completa`.
...
Se o usuario pedir proxima etapa, encaminhar para `peticao-completa`, `pdf` ou `doc`, conforme o caso.
