...
description: "Use para pesquisar, localizar e comparar jurisprudencia brasileira: STJ/STF, sumulas, repetitivos, repercussao geral, IRDR, IAC, acordaos e informativos. Para validar estrategia ou tese, use validar-tese."
---
...
- Se a tarefa for validar força de argumento, usar `validar-tese`.
- Se a tarefa for redigir peca com precedentes ja pesquisados, usar `peticao-final`.
- Se a tarefa for apenas resumir peca/autos, usar `analise-autos`.
