...
DEFAULT_CORPUS = Path(os.environ.get("PETICAO_CORPUS_DIR", "acervo-peticoes"))
...
def main() -> int:
    ...
    if not args.corpus.exists():
        parser.error(
            "corpus directory not found. Provide --corpus /path/to/petition-markdown "
            "or set PETICAO_CORPUS_DIR."
        )
